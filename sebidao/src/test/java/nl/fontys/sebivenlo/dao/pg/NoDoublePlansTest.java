...
public class NoDoublePlansTest extends DBTestHelpers {
    ...
    public static void setupClass() {
        ...
        daof.registerMapper( Truck.class, new TruckMapper( Integer.class, Truck.class ) );
        daof.registerMapper( TruckPlan.class, new TruckPlanMapper( Integer.class, TruckPlan.class ) );
        loadDatabase();
    }
