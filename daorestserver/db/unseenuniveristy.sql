...
--
-- Name: unseenstudents_id_seq; Type: SEQUENCE; Schema: public; Owner: hom
--

CREATE SEQUENCE public.unseenstudents_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.unseenstudents_id_seq OWNER TO hom;
...
CREATE TABLE public.unseenstudents (
    id integer DEFAULT nextval('public.unseenstudents_id_seq'::regclass) NOT NULL,
...
ALTER TABLE public.unseenstudents OWNER TO hom;

--
-- Data for Name: unseenstudents; Type: TABLE DATA; Schema: public; Owner: hom
--

COPY public.unseenstudents (id, lastname, firstname, tussenvoegsel, email, cohort, student_class, gender, dob) FROM stdin;
...
--
-- Name: unseenstudents_id_seq; Type: SEQUENCE SET; Schema: public; Owner: hom
--

SELECT pg_catalog.setval('public.unseenstudents_id_seq', 1, false);
...
ALTER TABLE ONLY public.unseenstudents
...
ALTER TABLE ONLY public.unseenstudents
    ADD CONSTRAINT unseenstudents_pk PRIMARY KEY (id);
