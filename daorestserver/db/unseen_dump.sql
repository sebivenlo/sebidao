...
--
-- Data for Name: exam_event; Type: TABLE DATA; Schema: public; Owner: hom
--

COPY public.exam_event (exam_event_id, name, event_date, teachers) FROM stdin;
\.


--
-- Data for Name: exam_results; Type: TABLE DATA; Schema: public; Owner: hom
--

COPY public.exam_results (id, exam_event_id, snummer, grade) FROM stdin;
\.


--
-- Data for Name: sresult; Type: TABLE DATA; Schema: public; Owner: hom
--

COPY public.sresult (snummer, grade) FROM stdin;
\.


--
-- Data for Name: students; Type: TABLE DATA; Schema: public; Owner: hom
--
...
3640451	Lenore	Coomes	\N	lenorecoomes@student.olifantys.nl	2021	DKAA	F	1999-04-25
\.


--
-- Name: exam_event_id_seq; Type: SEQUENCE SET; Schema: public; Owner: hom
--

SELECT pg_catalog.setval('public.exam_event_id_seq', 1, false);


--
-- Name: exam_result_id_seq; Type: SEQUENCE SET; Schema: public; Owner: hom
--
...
--
-- Name: students_id_seq; Type: SEQUENCE SET; Schema: public; Owner: hom
--
...
--
-- Name: students students_pk; Type: CONSTRAINT; Schema: public; Owner: hom
--
